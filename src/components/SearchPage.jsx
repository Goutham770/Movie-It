    ...
    <div className="container mx-auto p-4">
      ...
      >
        <input
          ...
          className="border-2 border-gray-300 hover:border-green-500 outline-none rounded-l-md p-2 w-full max-w-md"
        />
        <button
          type="submit"
          className="bg-green-400 hover:font-bold text-white px-4 rounded-r-md"
        >
          Search
        </button>
      </form>
      ...
      <div className="mb-4 flex justify-between items-center">
        <select
          ...
          value={type}
          className="border-2 cursor-pointer border-orange-300 rounded-lg p-2 font-poppins font-bold outline-none hover:border-green-500"
        >
        ...
        <button
          ...
          className="mt-4 bg-orange-600 text-white px-4 py-2 rounded-lg font-poppins hover:text-green-500 hover:bg-green-200"
        >
          View Starred Movies
        </button>
      </div>
