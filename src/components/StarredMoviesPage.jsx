  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center pb-10">
        <h1 className="text-4xl font-bold font-poppins text-green-500">
          Starred Movies
        </h1>
        <button
          onClick={() => navigate("/")}
          className="bg-green-500 text-white px-4 py-2 rounded-lg font-poppins hover:font-bold"
        >
          Back to Search
        </button>
      </div>
      ...
      {starredMovies.length === 0 ? (
        <p className="font-poppins text-yellow-300">You have not starred any movies yet.</p>
      ) : (
